...
<section id='cluster-info' class="page-section-sm">
    ...
    if(isset($cluster_status)) {
        ...
        $status_classes = array("ok"=>"text-success", "busy"=>"text-warning", "full"=>"text-danger");
        ...
        echo $this->element("help_tooltips/create_tooltip", array("tooltip_text"=> $tooltip_text_cluster_status, "tooltip_placement"=>"right", "override_span_class"=>"glyphicon glyphicon-question-sign", "use_html"=>true));
        echo "</ul>";
    }
...
<section id='job-info' class="page-section-sm">
        ...
        if (count($running_jobs) == 0) {
            ...
            // echo "<span class='material-icons'>delete</span> Delete selected jobs\n";
...
<?php echo $this->element("help_tooltips/enable_tooltips",  array("container"=>"#cluster-info")); ?>
