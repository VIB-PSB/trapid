    ...
    <p class="text-justify">TRAPID currently offers the following features:</p>
      ...
      <p class="text-justify">More information about these features and a comprehensive overview of the TRAPID capabilities can be found in the 			<?php echo $this->Html->link("documentation",array("controller"=>"documentation","action"=>"general")); ?>. </p>
		...
		<!--div class="subdiv" style="width:800px;margin-top:200px;">
			...
			<?php
      /*
				echo $this->Html->link("Login",array("controller"=>"trapid","action"=>"authentication"),
							array("class"=>"startlink"));
				echo "<span class='line'>&#8226;</span>\n";
				echo $this->Html->link("Register",array("controller"=>"trapid","action"=>"authentication","registration"),
							array("class"=>"startlink"));
				echo "<span class='line'>&#8226;</span>\n";
				echo $this->Html->link("Documentation",array("controller"=>"documentation","action"=>"index"),
							array("class"=>"startlink","target"=>"_blank"));
				echo "<span class='line'>&#8226;</span>\n";
				//echo "<a href='mailto:plaza@psb.vib-ugent.be' class='startlink'>Contact</a>\n";
				echo $this->Html->link("About",array("controller"=>"documentation","action"=>"about"),
							array("class"=>"startlink","target"=>"_blank"));
      */
			?>
			<!--/center>
		...
		<div class="subdiv">
			<?php
			echo $this->Form->create("Authentication",array("url"=>array("controller"=>"trapid","action"=>"authentication"),
				"type"=>"post"));
			?>
			...
			<?php
			echo $this->Html->link("Registration",array("controller"=>"trapid","action"=>"authentication","registration"));
			?>
			</form>
		</div>
		-->
