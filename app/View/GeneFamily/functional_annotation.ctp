	...
	<div class="subdiv">
		...
		<table cellspacing='0' cellpadding='0' style='width:800px;'>
			...
			foreach($go_descriptions as $go=>$desc){
				...
				echo "<tr $class>";				
				echo "<td>".$this->Html->link($go,array("controller"=>"functional_annotation","action"=>"go",$exp_id,$go_web))."</td>";				
				echo "<td>".$desc['desc']."</td>";
				echo "<td>".$this->Html->link("Transcripts",array("controller"=>"trapid","action"=>"transcript_selection",$exp_id,"gf_id",$gf_id,"go",$go_web))."</td>";
				echo "</tr>\n";
			}
			?>
		</table>
