	...
	<section class="page-section">
        <p class="text-justify">This module enables functional comparison of transcript subsets, by reporting functional annotation frequencies (ratios) between subsets and subset-specific annotations. </p>
        <p class="text-justify"><strong>Usage: </strong> select a functional annotation type and the two transcript subsets you wish to compare. </p>
        ...
        <section class="page-section-xs">
            ...
            <?php
            if(isset($error)) {
                echo "<p class='error text-danger text-justify'><strong>Error: </strong>".$error."</p><br>\n";
            }
            echo $this->Form->end();
            ?>
    ...
    <section class='page-section'>
        ...
        <div id="both" class="tab-pane active"><br>
            ...
            echo $this->Html->link($table_download_text,
...
<?php endif; ?>
    ...
    ?>
        <div id="both" class="tab-pane active">
            <h4><?=$available_types[$type]?> present in <code><?=$subset1?></code> and <code><?=$subset2?></code></h4>
        <ul class='tabbed_header list-unstyled list-inline padded-top-1em'>
