...
<div class="row">
    <div class="col-lg-9">
        <?php echo $this->Form->create(false, ["url" => ["controller" => "tools", "action" => "create_tax_subset/" . $exp_id], "type" => "post", "default" => "false", "id" => "create-subset-form", "class" => "form-inline", "name" => "create-subset-form"]); ?>
        <div class="form-group">
            <input class="form-control" placeholder="Subset name... " maxlength="50" name="subset-name" id="subset-name" type="text" required>
            <?php echo $this->element("help_tooltips/create_tooltip", ["tooltip_text" => $tooltip_text_subset_name, "tooltip_placement" => "top", "override_span_class" => "glyphicon glyphicon-question-sign"]); ?>
        </div> &nbsp;
...
<div id="content">
    ...
    <div class="tab-content">
        <div id="krona" class="tab-pane active"><br>
            <object type="text/html" id="krona-object" class="krona-display bordered" data="<?php echo $display_krona_url; ?>">
                Default content. If this appears, Krona HTML file failed to load.
            </object>
        </div>

        <div id="tree-view" class="tab-pane"><br>
            <div id="d3-tree-view" class="bordered"></div>
        </div>

        <div id="piecharts" class="tab-pane"><br>
            <div class="row tax-rank-row">
            ...
            <div class="row">
                <div class="col-md-4">
                    <?php echo
                    $this->element('charts/pie_domain', ["chart_title" => "Domain composition", "chart_subtitle" => "Total transcripts: " . $domain_sum_transcripts, "chart_data" => $top_tax_domain, "chart_div_id" => "top_tax_piechart"]);
                    ?>
                </div>
                <div class="col-md-8">
                    <div class="tab-content" id="top-tax-piecharts">
                        <div id="phylum-top-tax-pie-tab" class="tab-pane active">
                            <?php
                            echo $this->element('charts/pie_tax', ["chart_title" => "Phylum composition", "chart_subtitle" => "Total transcripts classified at that level: " . $phylum_sum_transcripts, "chart_data" => $top_tax_phylum, "chart_div_id" => "phylum_top_tax_piechart", "legend_tax_str" => "phyla"]);
                            ?>
                        </div>
                        <div id="order-top-tax-pie-tab" class="tab-pane">
                            <?php
                            echo $this->element('charts/pie_tax', ["chart_title" => "Order composition", "chart_subtitle" => "Total transcripts classified at that level: " . $order_sum_transcripts, "chart_data" => $top_tax_order, "chart_div_id" => "order_top_tax_piechart", "legend_tax_str" => "orders"]);
                            ?>
                        </div>
                        <div id="genus-top-tax-pie-tab" class="tab-pane">
                            <?php
                            echo $this->element('charts/pie_tax', ["chart_title" => "Genus composition", "chart_subtitle" => "Total transcripts classified at that level: " . $genus_sum_transcripts, "chart_data" => $top_tax_genus, "chart_div_id" => "genus_top_tax_piechart", "legend_tax_str" => "genera"]);
                            ?>
                        </div>
                    </div>
                </div>
        ...
        <div id="barcharts" class="tab-pane"><br>
            ...
            <div class="row">
                <div class="col-md-4">
                    <?php echo
                    $this->element('charts/bar_domain', ["chart_title" => "Domain composition", "chart_subtitle" => "Total transcripts: " . $domain_sum_transcripts, "chart_data" => $top_tax_domain, "chart_div_id" => "top_tax_barchart"]);
                    ?>
                </div>
                <div class="col-md-8">
                    <div class="tab-content" id="top-tax-barcharts">
                        <div id="phylum-top-tax-bar-tab" class="tab-pane active">
                            <?php echo
                            $this->element('charts/bar_tax', ["chart_title" => "Phylum composition", "chart_subtitle" => "Total transcripts classified at that level: " . $phylum_sum_transcripts, "chart_data" => $top_tax_phylum, "chart_div_id" => "phylum_top_tax_barchart"]);
                            ?>
                        </div>
                        <div id="order-top-tax-bar-tab" class="tab-pane">
                            <?php echo
                            $this->element('charts/bar_tax', ["chart_title" => "Order composition", "chart_subtitle" => "Total transcripts classified at that level: " . $order_sum_transcripts, "chart_data" => $top_tax_order, "chart_div_id" => "order_top_tax_barchart"]);
                            ?>
                        </div>
                        <div id="genus-top-tax-bar-tab" class="tab-pane">
                            <?php echo
                            $this->element('charts/bar_tax', ["chart_title" => "Genus composition", "chart_subtitle" => "Total transcripts classified at that level: " . $genus_sum_transcripts, "chart_data" => $top_tax_genus, "chart_div_id" => "genus_top_tax_barchart"]);
                            ?>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(create_subset_form).submit(function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo $this->Html->url(["controller" => "tools", "action" => "create_tax_subset", $exp_id], ["escape" => false]); ?>",
            type: 'POST',
...
<?php echo $this->element("help_tooltips/enable_tooltips",  ["container" => "#create-subset-form"]); ?>
