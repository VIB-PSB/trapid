        ...
        <div class="panel panel-default" id="choices">
            ...
            <div class="panel-body">
                <div class="col-md-4">
                    <?php
                    ///////////////// Left refinement /////////////////
                    echo $this->Form->create(false, ['id' => 'left_boxes', 'class' => 'refine_box']);
                ...
                <div class="col-md-4">
                    ...
                    echo $this->Form->create(false, ['id' => 'middle_refine_form', 'class' => 'refine_box']);
                    echo $this->Form->input("Minimum $col_names[1] size: ", ['options' => [], 'id' => 'middle_min']);
                    echo $this->Form->input('Normalization: ', [
                        'options' => ['None', 'Intersection', 'Cluster'],
                        'id' => 'normalization'
                    ]);
                    echo $this->Form->input('type: ', [
                        'options' => ['All', 'MF', 'BP', 'CC'],
                        'id' => 'type',
                ...
                <div class="col-md-4">
                    <?php
                    ///////////////// Right refinement /////////////////
                    echo $this->Form->create(false, ['id' => 'right_boxes', 'class' => 'refine_box']);
                    echo '<div class="left_col"></div><div class="right_col"></div><br>';
                    $options = [
                        'type' => 'button',
...
<section class="section-page-sm">
    ...
    <div id="sankey">
        ...
        echo $this->Html->script([
            ...
            'sankey',
            'sankey_intersection',
            'https://cdn.jsdelivr.net/gh/eligrey/canvas-toBlob.js@f1a01896135ab378aa5c0118eadd81da55e698d8/canvas-toBlob.js',
...
<script type="text/javascript">
    ...
    var export_base_name = "Sankey_Diagram_<?php echo str_replace(' ', '_', $col_names[0]) .
        '_' .
        str_replace(' ', '_', $col_names[1]); ?>";
    // PNG
    ...
    d3.select('#export_sankey_svg').on('click', function() {
        ...
        saveAs(new Blob([svgString], {
            type: "image/svg+xml;charset=utf-8"
        }), export_base_name + '.svg'); // FileSaver.js function
    });
