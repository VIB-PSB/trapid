<?php
echo $this->Html->script(['ftiens4.js', 'ua.js', 'd3-3.5.6.min.js', 'phyd3.min.js', 'msa.min.js']);
...
<section class="page-section-sm">
    <p class="text-justify">
        ...
        (<?php echo $gf_info['GeneFamilies']['num_transcripts']; ?> transcripts).
    </p>
    <?php
    ...
    <?php if (isset($previous_results) && $previous_results['msa'] == true) : ?>
        <p class="text-justify">
            <a id="new-tree-link" class="tree-results-link">
                <span class="glyphicon glyphicon-chevron-right"></span> Create MSA / phylogenetic tree with different species or settings
            </a>
            <a id="current-tree-link" class="tree-results-link hidden">
                <span class="glyphicon glyphicon-eye-open"></span> View current MSA / phylogenetic tree
            </a>
        </p>
    <?php endif; ?>
</section>
    ...
    <section class="page-section-sm" id="tree-results">
        <ul class="nav nav-tabs nav-justified" id="msa-tree-tabs" data-tabs="tabs">
            <?php if ($previous_results['tree'] == true) : ?>
                ...
                <li><a href="#msa-tab" data-toggle="tab">Multiple sequence alignment(s)</a></li>
            <?php else : ?>
        ...
        <div class="tab-content">
            <?php if ($previous_results['tree'] == true) : ?>
                <!-- PhyD3 controls were copied from the example given in the doc and adapted for TRAPID. -->
            ...
            <?php endif; ?>
            <div id="msa-tab" class="tab-pane <?php echo $previous_results['tree'] == false ? "active" : ""; ?>">
                <br>
                    ...
                    <div id="full-msa-view-tab" class="tab-pane active">
                        <div id="full-msa-wrapper" class="row msa-wrapper">
                            <div id="full-msa-view">
                                <div class="msa-viewer-loading text-center">
                                    <br>
            ...
            <div id="files-extra-tab" class="tab-pane"><br>
                <section class="page-section">
                    ...
                    <?php if ($previous_results['tree'] == true) : ?>
                        <section class="page-section-sm">
                            ...
                            <ul>
                                <li>
                                    <a href="<?php echo $this->Html->url(array("controller" => "tools", "action" => "view_tree", $hashed_user_id, $exp_id, $gf_id, "newick")); ?>">
                                        Download Newick tree</a>
                                </li>
                                <li>
                                    <a href="<?php echo $this->Html->url(array("controller" => "tools", "action" => "view_tree", $hashed_user_id, $exp_id, $gf_id)); ?>">
                                        Download PhyloXML tree</a>
                                </li>
                            </ul>
                        </section>
                    <?php endif; ?>
                    <section class="page-section-sm">
                        ...
                        <ul>
                            <li>
                                <strong>Unedited MSA</strong> (<?php echo $full_msa_length; ?> amino acids):
                ...
                <section class="page-section">
                    ...
                    <ul>
                        ...
                        <?php if ($previous_results['msa_stripped'] == true) : ?>
                            <li>
                                <strong>Alignment editing: </strong>
                                <?php echo "<code>" . $gf_info['GeneFamilies']['msa_stripped_params'] . "</code>"; ?>
                            </li>
                        <?php endif; ?>
                    </ul>
                    <p class="text-justify">
                        More information regarding used software versions, command-lines, and parameters can be found in the
...
<?php
$new_msa_tree_div_class = null;
if (isset($previous_results) && $previous_results['msa'] == true) {
    $new_msa_tree_div_class = " class='hidden'";
}
?>

<div id="new_msa_tree_div" <?php echo $new_msa_tree_div_class; ?>>
    ...
    <?php if (!isset($run_pipeline)) : ?>
        <div class="row" id="tree-creation-row">
            ...
            <?php endif; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        $checked = "checked";
                                        if (isset($include_subsets) && $include_subsets) {
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div id="species-tree-tab" class="tab-pane active"><br>
                                    <p class="text-justify">Please select the species for which you want to include the associated genes.</p>
                                    <div style="float:left;width:100%; max-height: 500px;overflow-y: auto;">
                                        <script type="text/javascript">
                                                ...
                                                foreach ($arr as $k => $v) {
                                                    if (!(is_numeric($k)  && is_numeric($v))) {
                                                        ...
                                                        if ($num_gf_species_clade == 0) {
                                                            ...
                                                            $selected_clade = 0;
                                                            if (array_key_exists($k, $sel_clades)) {
                                                                $selected_clade = 1;
                                                            }
                                                            ...
                                                            foreach ($v as $v1 => $v2) {
                                                                ...
                                                                if (is_numeric($v1) && is_numeric($v2)) {
                                                                    ...
                                                                    if ($num_genes == 0) {
                                                                        ...
                                                                        $selected_species = 0;
                                                                        if (array_key_exists($v2, $sel_species)) {
                                                                            $selected_species = 1;
                                                                        }
                                            ...
                                            if (isset($selected_clades)) {
                                                $sel_clades = $selected_clades;
                                            }
                                            if (isset($selected_species)) {
                                                $sel_species = $selected_species;
                                            }
                    ...
                    <p class="text-center">
                        <button type="submit" id="submit_button" <?php if ($no_sub) { echo "disabled='disabled'";} ?> class="btn btn-primary">
                            Create MSA / Tree
                        </button>
                    </p>
...
<?php if (isset($previous_results) && $previous_results['tree'] == true): ?>
    <script type="text/javascript">
        ...
        function loadPhyd3() {
            ...
            jQuery('#foregroundColorButton').colorpicker({
                color: opts.foregroundColor
            });
            jQuery('#backgroundColorButton').colorpicker({
...
<script type="text/javascript">
    ...
    document.getElementById("msa_only").onchange = function() {
        toggleTreeOptions()
    };
