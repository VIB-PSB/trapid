...
<div class="subdiv">
	...
	<?php
		$link_url	= $this->Html->url(array("controller"=>"functional_annotation","action"=>"go",$exp_id),true);
	?>
	...
	<script type="text/javascript">
	    ...
	    var graph_data    = <?php echo json_encode($all_graphs); ?>;
	    var enrich_data   = <?php echo json_encode($data); ?>;
	    var all_gos	      = <?php echo json_encode($accepted_gos); ?>;
