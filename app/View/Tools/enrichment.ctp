...
echo $this->Html->css(['enricher.css']);
?>
...
<section class="page-section-sm">
    ...
    echo "<label for='use_cache'><strong>Use cached results</strong></label>\n";
    echo $this->Form->end();
    ?>
</section>
...
<?php echo $this->element("help_tooltips/enable_tooltips",  ["container" => "#enrichment-form"]); ?>