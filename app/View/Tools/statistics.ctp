...
<div class="subdiv">
	...
	<div class="subdiv">
		<dl class="standard extra">
			...
			<dt>Largest GF</dt>
			<dd><?php echo $this->Html->link($biggest_gf['gf_id'],array("controller"=>"gene_family","action"=>"gene_family",$exp_id,$biggest_gf['gf_id']))." (".$biggest_gf['num_transcripts']." transcripts)";?></dd>
			<dt>#single copy</dt>
