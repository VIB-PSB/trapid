...
if(isset($error)){
	...
	$msa_url_1	= $this->Html->url(array("controller"=>"tools","action"=>"view_msa",$hashed_user_id,$exp_id,$gf_id,"normal"),true);
	echo "<dl class='standard'>\n";
	echo "<dt>View</dt>\n";
	echo "<dd>".$this->Html->link("View full multiple sequence alignment","javascript:$('form_msa_norm').submit();")."</dd>\n";
	echo "<dt>Download</dt>\n";
