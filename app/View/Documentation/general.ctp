        ...
        <div class="col-md-9" id="tutorial-col">
            <section class="page-section" id="introduction">
                ...
                <section class="page-section-sm">
                    ...
                    <p class="text-justify">Detailed information about the platform and its capabilities are provided in the different sections of this page. In
                        ...
                        <?php echo $this->Html->link('here', [
                            ...
                            'action' => 'tutorial'
                        ]); ?>, to guide non-experts through the different steps of processing a
                ...
                <section class="page-section-sm">
                    ...
                    <p class="text-justify">In case you publish results generated by third-party resources used in TRAPID, please cite the appropriate papers as well. References can be found on the <?php echo $this->Html->link(
                        'tools & parameters',
                        ['controller' => 'documentation', 'action' => 'tools_parameters']
            ...
            <section class="page-section" id="authentication">
                ...
                <p class="text-justify">Data security is a necessary concern when dealing with online platforms and
                    services. TRAPID requires users to be registered, and no user can access the data of any other user, except if explicitly requested (shared experiment).
                    User authentication is performed through username/password combination. </p>
                <p class="text-justify">To create a TRAPID account, click on the
                ...
                <p class="text-justify">Step-by-step instructions on how to create an account
                    and log in can be found in the
                    <?php echo $this->Html->link('tutorial', [
                        'controller' => 'documentation',
                        'action' => 'tutorial',
                        '#' => 'account-setup'
                    ]); ?>
            ...
            <section class="page-section" id="create-experiments">
                ...
                <p class="text-justify"> An overview of the content of the various reference databases can be found in the
                    <?php echo $this->Html->link('tools & parameters', [
                        'controller' => 'documentation',
                        'action' => 'tools_parameters',
                        '#' => 'ref-dbs'
                    ]); ?> documentation page, and step-by-step instructions on how to create an experiment
                    can be found in the
                    <?php echo $this->Html->link('tutorial', [
                        'controller' => 'documentation',
                        'action' => 'tutorial',
            ...
            <section class="page-section" id="initial-processing">
                ...
                <section class="page-section-sm" id="initial-processing-settings">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><code>Input sequences are CDS</code>: this option should be checked if input sequences are CDS (nucleotides). The ORF prediction step of the initial processing will be skipped and all sequences will be translated in <samp>+1</samp> frame. </li>
                    ...
                    <p class="text-justify">Click <code>Run initial processing</code> to launch the job. During this step, the experiment will become unavailable while the server performs
                        the initial processing of the data. Again, you will receive an e-mail when the processing has finished.</p>
                </section>
            ...
            <section class="page-section" id="basic-analyses">
                ...
                <p class="text-justify">After the initial processing of the data has finished, several new data
                    ...
                    user, accessible from the side menu of the experiment. Step-by-step instructions on how to explore some of these data types can be found in the <?php echo $this->Html->link(
                        'tutorial',
                        ['controller' => 'documentation', 'action' => 'tutorial', '#' => 'tutorial-1-explore']
                    ); ?>. </p>
                <h4 id="statistics">General statistics</h4>
                <div class="row">
                    <div class="col-md-4">
                        <div class="doc-figure">
                            <?php echo $this->Html->image('tutorial/optimized/general_statistics.png', [
                                'alt' => 'General statistics page',
                ...
                <section class="page-section-sm">
                    ...
                    <p class="text-justify">By creating transcript subsets, several new analyses become available, such as comparison of functional annotation between different subsets, or functional enrichment analysis.
                        Note that it is possible for a transcript to be assigned to multiple subsets, and that three transcript subsets are defined by default after initial processing completion, corresponding to protein-coding transcripts, RNA transcripts, and ambiguous transcripts (transcripts assigned to both an RNA and protein-coding gene family). </p>

                    <p class="text-justify">Step-by-step instructions on how to define and analyze subsets can be found in the
                        <?php echo $this->Html->link('tutorial', [
                            'controller' => 'documentation',
                            'action' => 'tutorial',
                            '#' => 'tutorial-1-subsets'
                ...
                <section class="page-section-sm">
                    ...
                    <p class="text-justify">
                        ...
                        Exported sequences can either be the uploaded transcript sequences, the inferred ORF sequences, or amino acid (translated ORF) sequences.
                ...
                <section class="page-section-sm">
                    ...
                    <p class="text-justify">
                        ...
                        They simply consist of a list of sequence identifiers (one identifier per line).
                ...
                <section class="page-section-sm">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="doc-figure">
                                <?php echo $this->Html->image('documentation/optimized/toolbox.png', [
                                    'alt' => 'Gene family page',
                                    'class' => 'img-responsive img-centered'
                                ]); ?>
                                <p class="text-justify doc-figure-legend small">
                                    <strong>Figure 2: gene family page toolbox.</strong> The toolbox is shown on top of any gene family page.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-8">
            ...
            <section class="page-section">
                ...
                <div class="doc-figure">
                    <?php echo $this->Html->image('documentation/optimized/ipr_enrichment_mmetsp0936.png', [
                        'alt' => 'Subset functional enrichment',
                        'class' => 'img-responsive img-centered'
                    ]); ?>
                    <p class="text-justify doc-figure-legend small">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="doc-figure">
                            <?php echo $this->Html->image('documentation/optimized/go_graph.png', [
                                'alt' => 'GO enrichment graph',
                                'class' => 'img-responsive img-centered'
                            ]); ?>
                            <p class="text-justify doc-figure-legend small">
                                <strong>Figure 4: GO enrichment graph example (biological process).</strong>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-8">
            ...
            <section class="page-section">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="doc-figure">
                            <?php echo $this->Html->image('documentation/optimized/tax_krona.png', [
                                'alt' => 'Taxonomic classification results',
                                'class' => 'img-responsive img-centered'
                            ]); ?>
                            <p class="text-justify doc-figure-legend small"><strong>Figure 5: taxonomic classification results visualization. </strong> Krona representation of the taxonomic classification results for <code>MMETSP0938</code> (<em>Ostreococcus mediterraneus</em>).</p>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <p class="text-justify">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="doc-figure">
                            <?php echo $this->Html->image('documentation/tax_subsets.gif', [
                                'alt' => 'Taxonomic classification subset',
                                'class' => 'img-responsive img-centered'
                            ]); ?>
                    ...
                    <div class="col-md-8">
                        ...
                        <p class="text-justify">To create a subset from the taxonomic classification result page, hold the <kbd>CTRL</kbd> key and click on the clades for which a subset should be created. Once the selection is over, type a name for the subset and click <code>create subset</code>. Figure 6 shows an example.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="page-section">
                ...
                <p class="text-justify">Step-by-step instructions on how to perform core GF completeness analysis can be found in the <?php echo $this->Html->link(
                    'tutorial',
                    ['controller' => 'documentation', 'action' => 'tutorial', '#' => 'tutorial-2']
                ); ?>.</p>
            </section>
            ...
            <section class="page-section">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="doc-figure">
                            <?php echo $this->Html->image('documentation/optimized/msa_viewer.png', [
                                'alt' => 'MSA viewer',
                                'class' => 'img-responsive img-centered'
                            ]); ?>
                    ...
                    <div class="col-md-8">
                        <p class="text-justify">Starting from a selected transcript, the user has the ability to create
                            ...
                            The versions and parameters used for either tool can be found in the
                            <?php echo $this->Html->link('tools & parameters', [
                                'controller' => 'documentation',
                                'action' => 'tools_parameters',
                                '#' => 'msa-phylogeny'
                        ...
                        <p class="text-justify">Step-by-step instructions on how to generate an MSA can be found in the
                            <?php echo $this->Html->link('tutorial', [
                                'controller' => 'documentation',
                                'action' => 'tutorial',
                                '#' => 'tutorial-1-phylogeny'
                            ]); ?>.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="page-section">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="doc-figure">
                            <?php echo $this->Html->image('tutorial/optimized/phylogenetic_tree.png', [
                                'alt' => 'Gene family phylogenetic tree',
                                'class' => 'img-responsive img-centered'
                            ]); ?>
                    ...
                    <div class="col-md-8">
                        ...
                        <p class="text-justify">In case the editing is too stringent and yields an edited MSA with zero or only a
                        ...
                        <p class="text-justify">Within TRAPID, four different tree creation programs can be used: FastTree2, IQ-TREE, PhyML, or RaxML.
                            ...
                            The versions and parameters used for each tool can be found on the
                            <?php echo $this->Html->link('tools & parameters', [
                                'controller' => 'documentation',
                                'action' => 'tools_parameters',
                                '#' => 'msa-phylogeny'
                        ...
                        <p class="text-justify">Finally, if the user has defined subsets within his/her experiment,
                            ...
                            much easier. By default, both the subset and meta-annotation information are displayed next to the
                            phylogenetic tree (see Figure 8). </p>
                        <p class="text-justify">Step-by-step instructions on how to create phylogenetic trees can be found in the
                            <?php echo $this->Html->link('tutorial', [
                                'controller' => 'documentation',
                                'action' => 'tutorial',
                                '#' => 'tutorial-1-phylogeny'
            ...
            <section class="page-section">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <!-- Extremely hackish -->
                        <div class="doc-figure">
                            <?php echo $this->Html->image('documentation/optimized/007_tree.png', [
                                'alt' => 'One-to-one orthology',
                                'class' => 'img-responsive img-centered'
                            ]); ?>
                    ...
                    <div class="col-md-6">
                        <div class="doc-figure">
                            <?php echo $this->Html->image('documentation/optimized/008_tree.png', [
                                'alt' => 'One-to-many orthology',
                                'class' => 'img-responsive img-centered'
                            ]); ?>
            ...
            <section class="page-section">
                ...
                <section class="page-section-sm">
                    <h4 id="assembly-resources">Sequence assembly resources</h4>
                    <p class="text-justify">Multiple online resources provide researchers with computational infrastructure and graphical user-interfaces to use state-of-the-art sequence assembly tools (e.g. rnaSPAdes or Trinity for <em>de novo</em> transcriptome assembly) and prepare their input data for use with TRAPID. </p>
                    <p class="text-justify">For example:</p>
                    <ul>
                        <li>
                            <a href="https://galaxyproject.org/" target="_blank" class="linkout">Galaxy</a> is a web-based solution that provides computational resources and graphical interfaces to facilitate the use of bioinformatics software.
                            <ul>
                                <li>Both the <a href="https://usegalaxy.org/" target="_blank" class="linkout">main</a> and <a href="https://usegalaxy.eu/" target="_blank" class="linkout">European</a> Galaxy instances feature multiple tools for sequence assembly. </li>
                                <li>Numerous other Galaxy instances are publicly available: please browse the <a href="https://galaxyproject.org/use/" target="_blank" class="linkout">Galaxy platform directory</a> for more information.</li>
                            </ul>
                        </li>
                        <li>The <a href="https://cyverse.org/" target="_blank" class="linkout">CyVerse</a> cyberinfrastructure also provides a web-based analytical platform on which it is possible to run various sequence assembly tools. </li>
                    </ul>
                </section>
                <section class="page-section-sm">
        ...
        <div class="col-md-3 scrollspy" id="navigation-col">
            <ul class="nav hidden-xs hidden-sm" id="sidebar-nav" data-spy="affix">
                ...
                <li><a href="#appendix">Appendix</a>
                    <ul class="nav">
                        <li><a href="#assembly-resources">Assembly resources</a></li>
