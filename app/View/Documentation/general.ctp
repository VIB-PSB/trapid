        ...
        <div class="col-md-9" id="tutorial-col">
            <section class="page-section" id="introduction">
                ...
                <section class="page-section-sm">
                    ...
                    <p class="text-justify">In case you publish results generated by third-party resources used in TRAPID, please cite the appropriate papers as well. References can be found on the <?php echo $this->Html->link("tools & parameters", array("controller" => "documentation", "action" => "tools_parameters")); ?> documentation page. </p>
            ...
            <section class="page-section">
                ...
                <div class="row">
                    ...
                    <p class="text-justify">Step-by-step instructions on how to generate an MSA can be found in the <?php echo $this->Html->link("tutorial", array("controller" => "documentation", "action" => "tutorial", "#"=>"tutorial-1-phylogeny")); ?>.</p>
                    </div>
                </div>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <p class="text-justify">Within TRAPID, four different tree creation programs can be used: FastTree2, IQ-TREE, PhyML, or RaxML.
                            ...
                            The versions and parameters used for each tool can be found on the <?php echo $this->Html->link("tools & parameters", array("controller" => "documentation", "action" => "tools_parameters", "#"=>"msa-phylogeny")); ?> page. </p>
            ...
            <section class="page-section">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="doc-figure">
                            <?php echo $this->Html->image('documentation/optimized/008_tree.png', array('alt' => 'One-to-many orthology', 'class'=>'img-responsive img-centered')); ?>
