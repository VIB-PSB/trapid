...
<aside id="sidebar" class="sidebar sidebar-colored open sidebar-stacked sidebar-shadow" role="navigation">
    ...
    <ul class="nav sidebar-nav">
        <li>
            <?php echo $html->link("Overview", array("controller" => "trapid", "action" => "experiment", $exp_id)); ?>
        </li>
        <li class="dropdown">
            ...
            <ul id="import-dropdown" class="dropdown-menu">
                <?php if ($process_state == "empty" || $process_state == "upload") : ?>
                    <li>
                        <?php echo $html->link("Transcripts", array("controller" => "trapid", "action" => "import_data", $exp_id)); ?>
                    </li>
                <?php else : ?>
                ...
                <?php if ($exp_info['transcript_count'] != 0) : ?>
                    <li>
                        <?php echo $html->link("Transcript subsets/labels", array("controller" => "trapid", "action" => "import_labels", $exp_id)); ?>
                    </li>
                <?php else : ?>
        ...
        <?php if ($exp_info['transcript_count'] != 0) : ?>
            <li>
                <?php echo $html->link("Export data", array("controller" => "trapid", "action" => "export_data", $exp_id)); ?>
            </li>
        <?php else : ?>
        ...
        <?php else :
            ...
            <li class="dropdown">
                ...
                <ul id="stats-dropdown" class="dropdown-menu">
                    <li>
                        <?php echo $html->link("General statistics", array("controller" => "tools", "action" => "statistics", $exp_id)); ?>
                    </li>
                    <li>
                        <?php echo $html->link("Length distribution transcripts", array("controller" => "tools", "action" => "length_distribution", $exp_id, "transcript")); ?>
                    </li>
                    <li>
                        <?php echo $html->link("Length distribution ORF", array("controller" => "tools", "action" => "length_distribution", $exp_id, "orf")); ?>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                <?php echo $html->link("Expanded/depleted GFs", array("controller" => "gene_family", "action" => "expansion", $exp_id)); ?>
            </li>
        <?php endif ?>
        ...
        <?php else : ?>
            <li>
                <?php echo $html->link("Explore subsets", array("controller" => "labels", "action" => "subset_overview", $exp_id)); ?>
            </li>
            <li class="dropdown">
                <a class="ripple-effect dropdown-toggle" href="#" data-toggle="dropdown">
                    Subset enrichment
                ...
                <ul id="stats-dropdown" class="dropdown-menu">
                    <li>
                        <?php echo $html->link("GO term enrichment", array("controller" => "tools", "action" => "enrichment", $exp_id, "go")); ?>
                    </li>
                    <li>
                        <?php echo $html->link("Protein domain enrichment", array("controller" => "tools", "action" => "enrichment", $exp_id, "ipr")); ?>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul id="stats-dropdown" class="dropdown-menu">
                    <li>
                        <?php echo $html->link("Label→Enriched GO→GF", array("controller" => "tools", "action" => "label_enrichedgo_gf2", $exp_id)); ?>
                    </li>
                    <li>
                        <?php echo $html->link("Label→Enriched IPR→GF", array("controller" => "tools", "action" => "label_enrichedinterpro_gf2", $exp_id)); ?>
                    </li>
                </ul>
            </li>
        <?php endif ?>
        ...
        <?php else : ?>
            <li class="dropdown">
                ...
                <ul id="stats-dropdown" class="dropdown-menu">
                    <li>
                        <?php echo $html->link("GO terms between subsets", array("controller" => "tools", "action" => "compare_ratios", $exp_id, "go")); ?>
                    </li>
                    <li>
                        <?php echo $html->link("Protein domains between subsets", array("controller" => "tools", "action" => "compare_ratios", $exp_id, "ipr")); ?>
                    </li>
                </ul>
            </li>
        <?php endif ?>
    ...
    <div style="position:relative;">
        <ul class="nav sidebar-nav">
            ...
            <li><?php echo $html->link("Documentation", array("controller" => "documentation", "action" => "index"), array("escape" => false)); ?></li>
            <li><?php echo $html->link("Back to experiments", array("controller" => "trapid", "action" => "experiments")); ?></li>
        </ul>
    </div>
    <!-- Sidebar text -->
