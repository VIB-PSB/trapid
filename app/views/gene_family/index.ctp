            ...
            foreach ($gene_families as $gene_family) {
                ...
                if ($exp_info['genefamily_type'] == "HOM") {
                    if ($exp_info['allow_linkout']) {
                        echo "<td>" . $html->link($gene_family['GeneFamilies']['plaza_gf_id'], $exp_info["datasource_URL"] . "/gene_families/view/" . $gene_family['GeneFamilies']['plaza_gf_id'], array("target"=>"_blank")) . "</td>\n";
                    } else {
