...
class Configuration extends AppModel {
    ...
    // A simple wrapper around `find()` to retrieve default Rfam clans and return them as an array.
    function getRfamClansDefault() {
        $default_clans = $this->find("first", array(
            'conditions' => array('method' => 'initial_processing_settings', 'key' => 'ncrna', 'attr' => 'default_rfam_clans'),
            'fields' => array('value')
        ));
