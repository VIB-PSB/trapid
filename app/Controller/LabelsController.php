...
class LabelsController extends AppController {
    var $components = array("Session", "Statistics", "TrapidUtils");
    var $name = "Labels";
    var $uses = array("AnnotSources", "Annotation", "Authentication", "Configuration", "ExperimentJobs",
        "ExperimentLog", "Experiments", "ExtendedGo", "GeneFamilies", "GfData", "GoParents", "HelpTooltips", "KoTerms",
        "ProteinMotifs", "Transcripts", "TranscriptsGo", "TranscriptsInterpro", "TranscriptsKo", "TranscriptsLabels");
    ...
    function view($exp_id = null, $label = null) {
        ...
        $num_transcripts = $this->TranscriptsLabels->find("count", array(
                "conditions" => array("experiment_id" => $exp_id, "label" => $label))
        );
        ...
        $transl_table_data = $this->Configuration->find("all", array(
            "conditions" => array("method" => "transl_tables", "attr" => "desc"),
    ...
    function delete_label($exp_id = null, $label_id = null) {
        ...
        $this->TranscriptsLabels->query(
            "DELETE FROM `completeness_results` WHERE `experiment_id`='" . $exp_id . "' AND `label` = " . $label_id . ";"
        );
        // Functional enrichment results
        $this->TranscriptsLabels->query(
            "DELETE FROM `functional_enrichments` WHERE `experiment_id`='" . $exp_id . "' AND `label` = " . $label_id . ";"
        );
    ...
    function retranslate_sqces($exp_id = null, $label_id = null) {
        ...
        if ($this->request->is('post')) {
            ...
            $label_data = $this->TranscriptsLabels->find("all", array(
                    "fields" => "DISTINCT label", "conditions" => array("experiment_id" => $exp_id))
            );
